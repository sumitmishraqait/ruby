...
# Store command line arguments specifically for defining IP Address & port of LDAT instance to undergo testing.
$ldat_instance_ip_address = ENV['IP'] || '10.102.11.224' #If not defined, by default test will be executed over 10.102.11.224 instance
$ldat_instance_port_number = ENV['PORT'] || '8080' #If not defined, by default port 8080 will be used
...
puts "Executing tests on remote browser via Browserstack.com"
  begin
	...
	caps["name"] = "Executing LDAT scripts over Browserstack.com"
...
puts "Executing tests on remote browser via Selenium Grid"
  begin
	...
	capabilities['name'] = "Executing LDAT scripts over Selenium Grid"
